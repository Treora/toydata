...
# See http://deeplearning.net/tutorial/mlp.html, and see license.txt for their
# copyright notice.
...
def train_mlp(classifier, training_set, validation_set, learning_rate=0.01,
